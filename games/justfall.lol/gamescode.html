...
<html><head><script>(function(){(function(){function e(g){this.t={};this.tick=function(h,m,f){var n=f!=void 0?f:(new Date).getTime();this.t[h]=[n,m];if(f==void 0)try{window.console.timeStamp("CSI/"+h)}catch(q){}};this.getStartTickTime=function(){return this.t.start[0]};this.tick("start",null,g)}var a;if(window.performance)var d=(a=window.performance.timing)&&a.responseStart;var p=d>0?new e(d):new e;window.jstiming={Timer:e,load:p};if(a){var b=a.navigationStart;b>0&&d>=b&&(window.jstiming.srt=d-b)}if(a){var c=window.jstiming.load;
...
goog.TRUSTED_SITE=!0;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;goog.readFlagInternalDoNotUseOrElse=function(a,b){var c=goog.getObjectByName(goog.FLAGS_OBJECT_);a=c&&c[a];return a!=null?a:b};goog.FLAGS_OBJECT_="CLOSURE_FLAGS";goog.FLAGS_STAGING_DEFAULT=!0;
...
</script><script>__dflags={"RefererProxy":"control","DynamicHeightGadgetRewriter":"true","CacheErrorThrottleCountLimit":"control","AnalyticsGadgetRewriter":"true","StyleAdjacencyGadgetRewriter":"true","CsiSample":"true","UseETags":"false","StyleTagExtractorGadgetRewriter":"true","LogResources":"false","ContentDivGadgetRewriter":"false","TimeSecsSinceEpochEnvGadgetRewriter":"true","AdsUrlGadgetRewriter":"true","ErrorCodesToLog":"control","YtVideoUrlGadgetRewriter":"true","ProxyingGadgetRewriter":"true","UseCajaSerializer":"false","CorpDomainSuffixes":"control","DflagsJsDebugGadgetRewriter":"true","GadgetBlacklist":"control","ClickTrackLogLoc":"On","MiniMessageGadgetRewriter":"true","EnableJsErrorTracking":"true","TrackResources":"false","ClickTrackGadgetRewriter":"true","InjectClientId":"true","DisableLoggingJs":"false","UseBrowserSpecificJson":"false","HtmlParser":"control","UseUrlGadgetWhitelist":"false","ResourceUsageJsDebugGadgetRewriter":"true","UrlTranslations":"control","EnableContextCache":"false","UseNoVarGlobals":"false","Monkeypatch":"control","ValidateTypeUrl":"true","UseJsPipelineForRendering":"false","ClickTrackBlacklist":"control"};
...
</script><script>gadgets.Prefs.setMessages_({});gadgets.Prefs.setDefaultPrefs_({});gadgets.io.preloaded_=[];</script><link href="https://cdn.jsdelivr.net/gh/greggman/webgl-helpers@06e3d45373af0f3ce8f58b472b61835d9678d23a/examples/unity/TemplateData/style.css" rel="stylesheet">

    
    
	
    <script>window["_ctlogloc"]="http:\/\/www.google.com\/ig\/log?src=gadget&";(function(){function d(a,b){this.gadgetUrl_=a;this.view_=b}d.prototype.init=function(){this.clickLog_=[];this.wait_=!1;this.waitingTime_=10};d.prototype.sendByImage=function(a){window.Image&&((new Image).src=a)};d.prototype.processClickLog=function(a,b){var e=[],c;for(c in a)a[c]&&e.push([c,b,"=",encodeURIComponent(a[c])].join(""));return e.join("&")};d.prototype.send=function(){if(this.clickLog_.length>0){var a=window._ctlogloc||"/gadgets/evthdlr?";a=a+"t=ct&m="+encodeURIComponent(this.gadgetUrl_)+
"&v="+this.view_+"&";for(var b=[],e=a.length,c=0,f=0,h=this.clickLog_.length;f<h;f++){var g=this.processClickLog(this.clickLog_[f],c);e+g.length>1E3&&(b.unshift("n="+c),this.sendByImage(a+b.join("&")),b=[],e=a.length,c=0,g=this.processClickLog(this.clickLog_[f],c));b.push(g);e+=g.length;c++}b.length>0&&(b.unshift("n="+c),this.sendByImage(a+b.join("&")));this.wait_=!0;this.clickLog_=[];var k=this;window.setTimeout(function(){k.send()},this.waitingTime_*1E3)}else this.wait_=!1};d.prototype.click=function(a){if(a=
a?a:window.event){var b=a.target||{};this.clickLog_.push({mx:a.clientX,my:a.clientY,id:b.id,nodeName:b.nodeName,href:b.href})}this.wait_||this.send()};typeof gadgets!="undefined"&&gadgets&&gadgets.util?(window._ct=new d(gadgets.util.getUrlParameters().url,gadgets.util.getUrlParameters().view),window._ct.init()):window.ClickTracker=d})();
</script><script>
/* mp-start */
...
/* mp-end */
</script></head><body dir="ltr" onmousedown="_ct.click(event);"><script src="https://cdn.jsdelivr.net/gh/greggman/webgl-helpers@06e3d45373af0f3ce8f58b472b61835d9678d23a/examples/unity/TemplateData/UnityProgress.js"></script><script src="https://cdn.jsdelivr.net/gh/D3ch/hell@e1ef9902521cfadf702a3bea91ccaeb1684c0f0f/Games/just-fall/UnityLoader.js"></script><script>
      var gameInstance = UnityLoader.instantiate("gameContainer", "https://cdn.jsdelivr.net/gh/D3ch/hell@e1ef9902521cfadf702a3bea91ccaeb1684c0f0f/Games/just-fall/WebGL.json", {onProgress: UnityProgress,Module:{onRuntimeInitialized: function() {UnityProgress(gameInstance, "complete")}}});
